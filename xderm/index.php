...
<div class="block moving-glow">
	<center>
    <img src="img/image.png" width: auto></a>
    <form action="logout.php">
            <button type="submit" class="btn geser">Logout <i class="fa fa-sign-out"></i></button>
		</form>	
     <form method="post">
		<center>
...
<table align="center"><tr><td class="col-butt">	
	<h4 id="time" style="color:#d48313" class="btn geser" ></h4>	
	<h4 id="div_refresh"  class="btn geser" ></h4>
	<h4 id="ip" style="color:#70c3d4" class="btn geser" ></h4>
	<h4 id="address" style="color:#70c3d4" class="btn geser" ></h4>
	<h4 id="isp" style="color:#70c3d4" class="btn geser" ></h4>	
	</td></tr>
	</table>	
...
<center><br>
	<div class="nganu slide" style="height:54px">
        Logo by Helmi Amirudin<br>Remod Ver guard<br>
